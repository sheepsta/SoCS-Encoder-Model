...
parser.add_argument('--obs_file', type=str,
                    default='/Users/juliusarolovitch/SoCS-Encoder-Model/dataset/obs_cloud/obc20000.dat', help='obstacle point cloud file')
# parser.add_argument('--path_file', type=str,
#                     default='./results/env_0/path_0.txt', help='path file')
